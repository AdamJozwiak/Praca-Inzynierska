...
\section{Wstęp}
{
  ...
  \subsection{Licencje}
  {
    Praca została opracowana przy wykorzystaniu technologii opartych na następujących
    licencjach:
    \begin{itemize}
      \item Flutter - BSD 3-Clause “New” or “Revised” License
      \item Dart - BSD 3-Clause "New" or "Revised" License
      \item VIM - Licencja Open-Source, GPL-Compatible 
      \item Android Studio - Apache License 2.0
      \item Pluginy wykorzystane w projekcie: 
      \begin{itemize}
        \item http - BSD 3-Clause “New” or “Revised” License 
        \item flutter\_spinkit - MIT License 
        \item table\_calendar - Apache License 2.0
        \item avatar\_glow - MIT License 
        \item speech\_to\_text - BSD 3-Clause “New” or “Revised” License 
        \item firebase\_auth - BSD 3-Clause “New” or “Revised” License 
        \item cloud\_firestore - BSD 3-Clause “New” or “Revised” License 
        \item provider - MIT License
        \item percent\_indicator - BSD 3-Clause “New” or “Revised” License  
      \end{itemize}
    \end{itemize}
  }
}
\section{Teoria}
{
  \subsection{Rynek aplikacji mobilnych}
  {
    ...
    \begin{figure}[H]
      ...
      \captionsource{Wykres udziału w rynku poszczególnych mobilnych systemów operacyjnych na przestrzeni 10 lat}{\cite{os}}
      \label{fig:android}
    \end{figure}
    ...
    \begin{figure}[H]
      ...
      \captionsource{Komputery, a smartphony na przestrzeni lat 2013-2016}{\cite{os1}}
      \label{fig:2013}
    \end{figure} 
    \begin{figure}[H]
      \centering
      \includegraphics[width=.9\textwidth]{systems_chart2.png}
      \captionsource{Komputery, a smartphony na przestrzeni lat 2016-2019}{\cite{os2}}
      \label{fig:2016}
    \end{figure} 
