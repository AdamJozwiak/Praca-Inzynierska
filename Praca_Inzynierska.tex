  ...
  \subsection{Analiza konkurencyjnych rozwiązań}
  {
    ...
    \subsubsection{Fitatu}
    {
      ...
      \begin{itemize}
        ...
        \begin{figure}[H]
          ...
          \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.8\linewidth]{fitatu_pro_3.jpg}
          ...
          \label{fig:fit2}
        \end{figure} 
        \item Aplikacja posiada bardzo dokładną listę najróżniejszych składników odżywczych,
        rozpisanych w bardzo przejrzysty sposób, co pozwala na niezwykle szczegółowe
        rozplanowanie diety
        \begin{figure}[H]
          \centering
          \includegraphics[width=.4\textwidth]{fitatu_pro_4.jpg}
          \caption{Fitatu - Ekran szczegółowego podsumowania}
          \label{fig:fit3}
        \end{figure} 
        \item W aplikacji jest dostępny za darmo czarny motyw, co zwiększa komfort
        użytkowania i nie męczy wzrok, zwłaszcza w porach nocnych
      \end{itemize}
      Do największych wad można zaliczyć:
      \begin{itemize}
        \item Bardzo duży rozmiar banerów informacyjnych, zasłaniających większą część
        interfejsu
        \begin{figure}[H]
          \centering
          \includegraphics[width=.45\textwidth]{fitatu_con_1.png}
    ...
    \subsubsection{Yazio}
    {
      ...
      \begin{itemize}
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=.4\textwidth]{yazio_2.jpg}
      ...
      \begin{figure}[H]
        \centering
        \includegraphics[width=.4\textwidth]{yazio_3.jpg}
    ...
    \subsubsection{Fatsecret}
    {
      ...
      \begin{itemize}
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=.4\textwidth]{fatsecret_2.png}
          \caption{Fatsecret - Ekran podsumowujący}
          \label{fig:fat2}
        \end{figure}
        \item Sekcja "Raporty" pozwala zobaczyć podsumowanie na przestrzeni dłuższego okresu
        czasu.
        \begin{figure}[H]
          \centering
          \includegraphics[width=.4\textwidth]{fatsecret_3.png}
          \caption{Fatsecret - Ekran raportu}
          \label{fig:fat3}
        \end{figure}
      \end{itemize}
      Do wad Fatsecret można zaliczyć:
      \begin{itemize}
        \item Ilość wartości odżywczych, która jest mniej dokładna, niż w przypadku aplikacji 
        Fitatu, jednak zdecydowanie większa niż w bezpłatnej wersji Yazio
        \item Do odblokowania wszystkich funkcji aplikacja zmusza użytkowania do założenia
        konta.
      \end{itemize}
    }
  }
...
\section{Technologie i narzędzia wykorzystane w projekcie}
{
  ...
  \subsection{Dart}
  {
    ...
    tak zyskuje coraz większą popularność dzięki środowisku programistycznemu opracowanemu
    przez Google, o nazwie "Flutter".
  }
  \subsection{Flutter}
  {
    Flutter jest środowiskiem programistycznym względnie młodym, gdyż został pierwszy
    raz zaprezentowany w roku 2015 i miał początkowo służyć jako nowoczesna platforma
    do tworzenia aplikacji na system Android, a jego wersja alfa (0.0.6) została wydana
    w 2017 roku. Opracowany na bazie języka programistycznego Dart, Flutter skupia się
